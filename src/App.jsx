...
const App = () => {
  return (
    <div className="flex justify-center mt-32">
      <div className="h-128 w-110 bg-gradient-to-b border border-slate-400/15 from-slate-100/20 to-blue-400/6 via-slate-100/10 via-50% rounded-2xl flex justify-center items-center">
        <div className="h-108 w-90 bg-gradient-to-t  from-slate-100 to-blue-500/20 via-slate-100 via-70% rounded-2xl p-5  flex flex-col justify-between">
          <div className="flex justify-center">
            <div className="flex flex-col justify-center items-center">
              <div className="flex px-1.5 py-1 bg-slate-50/40 border border-neutral-400/40 rounded-full justify-center items-center">
                <p className="italic font-medium text-[10px] font-semibold">
                  Powered by
                </p>
                <img className="w-5" src="razorPay.png" alt="" />
              </div>
              <h1 className="text-xl font-semibold tracking-wide mt-2">
                Check-In QR Code
              </h1>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center gap-2">
            ...
            <h2 className="font-semibold text-sm">RazorPay</h2>
          </div>
